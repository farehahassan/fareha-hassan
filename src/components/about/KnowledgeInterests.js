const knowledge = [
  { id: 1, text: "Flutter, Firebase" },
  { id: 2, text: "React JS, Next JS , Rest APIs" },
  { id: 3, text: "Tailwind, CSS" },
  { id: 4, text: "MongoDB, MySQL, Supabase" },
  { id: 5, text: "Graphic Designing" },
];
const interests = [
  { id: 1, text: "Create Mobile Apps" },
  { id: 2, text: "Create Websites" },
  { id: 3, text: "Freelancing" },
  { id: 4, text: "Graphic Desiging" },
